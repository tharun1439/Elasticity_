...
# ---------------- STEP 3 ----------------
    ...
    ep_pct = (delta_q / q1) / (delta_p / p1) if p1 != 0 and delta_p != 0 else 0
    ...
    c1.metric("Prop", round(ep_prop, 2))
    c2.metric("Pct", round(ep_pct, 2))
    c3.metric("Arc", round(ep_arc, 2))
